    ...
    descriptions = {
        ...
        Berry = {
            ...
            c_poke_lum_berry = {
                name = 'Lum Berry',
                text = {
                    "Remove debuff from {C:attention}1{} selected card",
                }
            },
            c_poke_sitrus_berry = {
                name = 'Sitrus Berry',
            ...
            c_poke_razz_berry = {
                ...
                text = {
                    ...
                    "earn {C:money}money{} equal to the amount drained",
                }
            },
            c_poke_bluk_berry = {
                name = 'Bluk Berry',
            ...
            c_poke_pomeg_berry = {
                ...
                text = {
                    ...
                    "earn {C:money}money{} equal to {X:money,C:white}X#3#{} the amount drained",
                }
            },
            c_poke_kelpsy_berry = {
                name = 'Kelpsy Berry',
            ...
            c_poke_jaboca_berry = {
                name = 'Jaboca Berry',
                text = {
                    "Reduce the score requirement of the",
                    "current {C:attention}Blind{} by {C:attention}10%{}",
                }
            },
            c_poke_rowap_berry = {
                name = 'Rowap Berry',
